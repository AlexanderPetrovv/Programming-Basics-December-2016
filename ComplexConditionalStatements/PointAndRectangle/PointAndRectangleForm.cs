...
{
    public partial class PointAndRectangleForm : Form
    {
        public PointAndRectangleForm()
        {
            InitializeComponent();
        }
        ...
        private void Draw()
        {
            ...
            else if (x < left || x > right || y < up || y > down)
            {
                ...
                this.labelLocation.BackColor = Color.OrangeRed;
            }
            else if (((x == left) || (x == right)) &&
                     ((y == up) || (y == down)))
            {
                this.labelLocation.Text = "Corner";
                this.labelLocation.BackColor = Color.Coral;
            }
            else
            {
                this.labelLocation.Text = "Border";
                this.labelLocation.BackColor = Color.LightBlue;
            }
        ...
        private void PointAndRectangleForm_Load(object sender, EventArgs e)
        {
            Draw();
        }

        private void PointAndRectangleForm_Resize(object sender, EventArgs e)
        {
            Draw();
        }
    }
